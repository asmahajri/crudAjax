$(document).ready(function(){
    ...
    $.getJSON("http://localhost:8000/php_api/product/read_one.php?id=" + id, function(data){
        ...
        $.getJSON("http://localhost:8000/php_api/category/read.php", function(data){
...
// get form data
        ...
        $.ajax({
            url: "http://localhost:8000/php_api/product/update.php",
            type : "POST",
